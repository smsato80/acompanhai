...
export function DashboardMockup() {
  return (
    <section className="py-20 lg:py-24" aria-labelledby="demonstracao-title">
      <div className="relative mx-auto max-w-5xl">
        ...
        <div className="relative rounded-[2rem] border border-white/15 bg-white/[0.06] p-4 shadow-2xl shadow-black/30 backdrop-blur-xl">
          <div className="rounded-[1.5rem] border border-white/10 bg-panel p-6 sm:p-8">
            <div className="flex flex-col gap-4 border-b border-white/10 pb-6 sm:flex-row sm:items-start sm:justify-between">
              <div>
                <p className="text-xs font-semibold uppercase tracking-[0.2em] text-mint">Demonstração</p>
                <h2 id="demonstracao-title" className="mt-2 text-2xl font-semibold sm:text-3xl">
                  Uma visão clara do seu acompanhamento.
                </h2>
              </div>
              <span className="w-fit rounded-full border border-white/10 px-3 py-1 text-xs font-medium text-slate-400">
                Dados fictícios
              </span>
            </div>
